...
public class ViewAdapterApproved extends RecyclerView.Adapter<ViewAdapterApproved.ViewHolder> {
    /**
    ...
    public ViewAdapterApproved(Context context, List<Appointment> listData){
        mListData = listData;
        mContext = context;
    }
    ...
    @Override
    public ViewAdapterApproved.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewAdapterApproved.ViewHolder viewHolder = new ViewAdapterApproved.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(ViewAdapterApproved.ViewHolder holder, int position) {
        // bind data to the view holder
        Appointment m = mListData.get(position);
        holder.tvReason.setText(m.getReason());
        holder.tvName.setText(m.getStudent().getName());
        holder.tvDate.setText(m.getDate() + " " + m.getTime());
