    ...
    public void addNewAppointment(View v) {
        ...
        call.enqueue(new Callback<Appointment>() {
            ...
            public void onResponse(Call<Appointment> call, Response<Appointment> response) {
                ...
                boolean isBooked = isBooked(student.getToken(), a.getLecturer_id(), a.getDate(), a.getTime());
                if (addedAppointment != null && !isBooked) {
                    // display message
                    Toast.makeText(context,
                             "Your consultation request is successfully sent to " + lecturer.getUsername() + " ." + isBooked,
                            Toast.LENGTH_LONG).show();
    ...
    public boolean isBooked(String apiKey, int lectId, String date, String time) {
        ...
        call.enqueue(new Callback<Appointment>() {
            ...
            public void onResponse(Call<Appointment> call, Response<Appointment> response) {
                ...
                Appointment bookedAppointment = response.body();
